...
<!--                <li style="margin-left: 20px;">Additional Fields</li>-->
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-md-4">
            ...
            <div class="form-group">
                <label for="select" class="col-lg-4 control-label">Religion</label>
                <div class="col-lg-4">
                    <?php
                    $drop = array();
            ...
            <div class="form-group">
                <label for="select" class="col-lg-4 control-label">batch</label>
                <div class="col-lg-3">
        ...
        <div class="col-md-4">
            ...
            <br><br>
            <div class="form-group">
                <label for="select" class="col-lg-3 control-label">Hostel</label>
                <div class="col-lg-4">
                    <?php
                    $drop = array();
            ...
            <div class="form-group">
                ...
                <label for="inputText" class="col-lg-4 control-label">jamb No.</label>
                <div class="col-lg-6">
