                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <!--                      <li><a href="-->
                            <? //=site_url('accounts/import'); ?><!--">Import</a></li>-->
                            ...
                            <li><a href="<?= site_url('accounts/open_balance_editor'); ?>">Opening Balance Editor</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-expanded="false">Financial Accounting <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-expanded="false">Final Accounts<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-expanded="false">Account Books<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-expanded="false">Interest Calculation<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?= site_url('accounts/simple_interest_calculation') ?>">Simple Interest
                                    Calculation</a></li>
                            ...
                            <li><a href="<?= site_url('accounts/bill_wise_interest_calculation') ?>">Bill Wise Interest
                                    Calculation</a></li>
                        </ul>
                    </li>
                </ul>
