                    ...
                    <?php if (count($data)): ?>
                        ...
                        <tr class="">
                            <?php foreach ($it as $student_det): ?>
                                ...
                                <td>
                                    <?php echo $student_det[0]['class']; ?>
                                </td>
                                <td>
                                    <?php echo $student_det[0]['section']; ?>
                                </td>
                                <td>
                                    <?php echo $student_det[0]['count(status)']; ?>
                                </td>
                                <?php $i++; ?>
                                <td class="text-danger">
                                    <?php echo $student_det[1]['count(status)']; ?>
                                </td>
                                <td>
                                    <?php echo $student_det[2]['count(status)']; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
